...
public interface SNRNAGeneExpressionSummaryRepository extends CrudRepository<SNRNAGeneExpressionExpressionSummaryValue, GeneExpressionId> {
    ...
    @Query(value = "SELECT snc.cluster, snc.cluster_name, snc.cell_count, snc.cluster_id as id, snr.tissue_type, snr.gene, snr.p_val as pval, snr.p_val_adj as pval_adj, snr.fold_change, snr.pct_1 as pct1, snr.pct_2 as pct2, snr.avg_exp as avg_exp " +
