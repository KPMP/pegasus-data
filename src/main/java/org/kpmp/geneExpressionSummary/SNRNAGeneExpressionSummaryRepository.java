...
@Repository
interface SNRNAGeneExpressionSummaryRepository extends CrudRepository<SNRNAGeneExpressionSummartValue, String> {
	...
	List<SNRNAGeneExpressionSummartValue> findByTissueAndGeneAllClusters(@Param("geneSymbol") String geneSymbol,
			@Param("tissueType") String tissueType);

	@Override
	List<SNRNAGeneExpressionSummartValue> findAll();
