...
public class GeneExpressionSummaryServiceTest {
    ...
    public void testGetByDataTypeTissueTypeAndGene() throws Exception {
        ...
        List<? extends GeneExpressionSummary> resultsSC = geneExpressionService.getByDataTypeTissueTypeAndGene("sc", "gene", "aki");
        assertEquals(scResults, resultsSC);
        assertEquals("sc", resultsSC.get(0).getDataType());
        List<? extends GeneExpressionSummary> resultsSN = geneExpressionService.getByDataTypeTissueTypeAndGene("sn", "gene", "aki");
